...
% Example Usage:
%
%      url = 'http://malachite.rss.chalmers.se/rest_api/v3/ptz/2015-01-03/AC1/2/7002908396'
%      url = 'http://malachite.rss.chalmers.se/rest_api/v3/apriori/O3/2015-01-03/AC1/2/7002908396'
%      y = get_scan_aux_data(url)
